...
export interface ConfigItem 
{
    [itemId: string]: {
        ...
        addtoPosterSlots: boolean
        addtoStatuetteSlots: boolean
        addPosterToMaps: boolean
        addtoLootLocation: boolean
        LootLocation: string
        ...
        QuestLocation: QuestLocationEntry[]
...
export type QuestMap =
    ...
    | "lighthouse"
    | "rezervbase"      // Reserve
    | "sandbox"         // Ground Zero (<21)
    | "sandbox_high"    // Ground Zero (21+)
    | "tarkovstreets"   // Streets of Tarkov
    | "woods"


export interface QuestLocationEntry {
    Map: QuestMap[]
    Position: Ixyz
    Rotation: Ixyz
    Probability?: number
